...
export const Policy = ({ setTitle }) => {
  ...
  return (
    <div className="bg-white px-8 py-6 -m-4">
      <p className="p">この利用規約（以下、「本規約」といいます。）は、霞が関用語辞典運営（以下、「運営」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、サービスをご利用いただきます。また、個人情報などの取り扱いについて<Link to={"/privacy"} className="link">プライバシーポリシー</Link>にまとめておりますので、併せてご確認ください。</p>
